...
export default function ChartsSection({ movimientos, ventas }) {
    const ventasPorDia =
        ventas
            ?.reduce((acc, venta) => {
                const fecha = venta.saleDate || venta.date || "Sin fecha";
    ...
    const movimientosPorTipo =
        movimientos?.reduce((acc, mov) => {
            const tipo = mov.type || mov.tipo || "Otro";
    ...
    const COLORS = ["#660000", "#801A1A", "#A6A6A6", "#D1A319", "#4D4D4D"];
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col justify-between">
                <h3 className="text-sm font-bold text-cixoil-red mb-4">
