...
git 
    ...
    return (
        <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-gray-100 relative">
            {/* Selector de Idioma (Arriba a la derecha del formulario o contenedor) */}
            ...
            <div className="flex flex-col items-center text-center mb-8">
                ...
                <div className="flex items-center gap-3 w-full mt-3">
                    ...
                    <p className="text-xs text-cixoil-grayText tracking-wide uppercase">Inicia sesión para continuar</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                    <div className="flex justify-between items-center mb-1.5">
                        ...
                        <a href="#" className="text-xs font-semibold text-cixoil-green hover:underline">
                ...
                <button
                    type="submit"
                    className="w-full bg-cixoil-red text-white py-3 px-4 rounded-lg font-semibold text-sm hover:bg-red-900 transition-colors flex items-center justify-center gap-2 group shadow-md"
                >
                ...
                <div className="relative flex py-2 items-center">
                    ...
                    <span className="flex-shrink mx-4 text-xs text-gray-400">o continúa con</span>
                    <div className="flex-grow border-t border-gray-200"></div>
                </div>
            ...
            <div className="text-center mt-6 text-sm text-gray-600">
                ...
                <a href="#" className="font-semibold text-cixoil-green hover:underline">
