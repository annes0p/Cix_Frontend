                ...
                <main className="p-6 space-y-6 overflow-y-auto w-full max-w-[1600px] mx-auto">
                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div>
                                    <StockCritico
                                        tableData={dashboardData?.criticalStock}
                                    />
                                </div>
                                <div>
                                    <UltimasVentas
                                        salesData={dashboardData?.latestSales}
                                    />
                                </div>
                            </div>
                        </>
                    ...
                    <footer className="flex items-center justify-between text-[11px] font-medium text-gray-400 pt-2 border-t border-gray-200/60">
                        <div className="flex items-center gap-2">
                            <span
                                className={`w-2 h-2 rounded-full ${loading ? "bg-amber-500 animate-spin" : "bg-emerald-500 animate-pulse"}`}
                            ></span>
                            <span>
                                {loading
                                    ? "Consultando..."
